...
from lib.http import normalize_target, host_of
...
def run_mode(mode: str, target: str, args: Namespace) -> List[ScanResult]:
    ...
    if getattr(args, 'crawl', False) or getattr(args, 'subdomain', False) \
        ...
        if args.crawl or args.js_extract:
            ...
            crawler = Crawler(max_depth=args.crawl_depth, max_pages=args.crawl_max_pages,
                              same_host_only=True, include_static=False)
