...
DEFAULT_PORTS = [
    ...
    445, 465, 514, 587, 636, 873, 993, 995, 1080, 1433, 1521, 1723, 2049,
    2181, 2375, 2376, 3128, 3306, 3389, 4440, 4848, 5000, 5432, 5632, 5900,
    5984, 6379, 7001, 7002, 8000, 8009, 8080, 8081, 8088, 8089, 8443, 8448,
    8888, 8983, 9000, 9042, 9090, 9200, 9300, 9999, 10000, 11211, 27017,
    50000, 50030, 50070, 61616, 61613,
]
...
PORT_SERVICE_MAP = {
    ...
    3128: 'squid', 3306: 'mysql', 3389: 'rdp', 4440: 'rundeck',
    4848: 'glassfish', 5000: 'flask-dev', 5432: 'postgresql', 5632: 'pcanywhere',
    5900: 'vnc', 5984: 'couchdb', 6379: 'redis', 7001: 'weblogic',
    7002: 'weblogic-ssl', 8000: 'http-alt', 8009: 'ajp', 8080: 'http-proxy',
    8088: 'hadoop-yarn', 8089: 'splunk', 8443: 'https-alt', 8888: 'http-alt',
    8983: 'solr', 9000: 'php-fpm', 9042: 'cassandra', 9090: 'prometheus',
    9200: 'elasticsearch', 9300: 'elasticsearch-node', 9999: 'java-rmi',
    10000: 'webmin', 11211: 'memcached', 27017: 'mongodb',
    50000: 'sap', 50030: 'hadoop', 50070: 'hadoop-namenode',
    61616: 'activemq', 61613: 'activemq-stomp',
}
