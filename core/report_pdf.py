...
def render_pdf(builder, out_path):
    ...
    # === 样式定义 ===
    title_style = ParagraphStyle('ChTitle', fontName=F, fontSize=24,
                                  alignment=1, spaceAfter=10, leading=30)
    subtitle_style = ParagraphStyle('ChSubtitle', fontName=F, fontSize=12,
                                     alignment=1, textColor=colors.HexColor('#656d76'),
                                     spaceAfter=6, leading=18)
    h2_style = ParagraphStyle('ChH2', fontName=F, fontSize=16,
                               spaceBefore=20, spaceAfter=10, leading=22,
                               textColor=colors.HexColor('#1f2328'))
    body_style = ParagraphStyle('ChBody', fontName=F, fontSize=10,
                                leading=16, textColor=colors.HexColor('#1f2328'))
    cell_style = ParagraphStyle('ChCell', fontName=F, fontSize=8,
                                leading=12, textColor=colors.HexColor('#1f2328'))
    cell_header = ParagraphStyle('ChCellH', fontName=F, fontSize=9,
                                  leading=13, textColor=colors.white, alignment=1)
    fix_title_style = ParagraphStyle('FixTitle', fontName=F, fontSize=11,
