    ...
    return {
        ...
        "value": {
            "java.lang": {
                "type=Memory": {
                    "op": {},
                    "attr": {"HeapMemoryUsage": {"rw": False, "type": "javax.management.openmbean.CompositeData"}},
                },
            },
            "com.sun.management": {
...
def _route(p):
    ...
    if path == "/":
        ...
        return json_body(
            {"timestamp": "2024-01-01T00:00:00.000Z", "status": 404, "error": "Not Found", "path": "/"}, 404
        )
    ...
    return json_body({"timestamp": "2024-01-01T00:00:00.000Z", "status": 404, "error": "Not Found", "path": path}, 404)
