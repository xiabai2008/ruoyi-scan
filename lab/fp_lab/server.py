...
def render(target_id):
    ...
    if target_id == "wordpress":
        return (
            ...
            "<p>Powered by WordPress</p></body></html>"
        ), "text/html"

    if target_id == "joomla":
        return (
            "<html><head><title>Joomla Site</title>"
            '<meta name="generator" content="Joomla! 4.0"></head>'
            '<body><div id="joomla-container"><h1>Welcome to Joomla</h1>'
            "<p>Open Source Matters</p></div></body></html>"
        ), "text/html"
    ...
    if target_id == "django":
        return (
            "<html><head><title>The install worked successfully!</title></head>"
    ...
    if target_id == "apache_welcome":
        return (
            "<html><head><title>Apache HTTP Server Test Page</title></head>"
            "<body><h1>It works!</h1>"
    ...
    if target_id == "weak_ruoyi_keyword":
        ...
        return (
            "<html><head><title>某企业管理系统</title></head>"
            "<body><h1>企业管理系统</h1>"
