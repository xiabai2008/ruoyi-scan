...
def generate_web_ui(output_path: str = None, api_base_url: str = "", title: str = "Ruoyi-Scan 控制台") -> str:
    """生成 Web UI HTML 文件
    ...
    content = content.replace("</body>", f"<!-- Generated by Ruoyi-Scan at {gen_time} -->\n</body>")
